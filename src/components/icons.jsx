export function IconGitHub({ className = '', ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m14.828 12 1.415 1.414 2.828-2.828a4 4 0 0 0-5.657-5.657l-2.828 2.828L12 9.172l2.828-2.829a2 2 0 1 1 2.829 2.829zM12 14.829l1.414 1.414-2.828 2.828a4 4 0 0 1-5.657-5.657l2.828-2.828L9.172 12l-2.829 2.829a2 2 0 1 0 2.829 2.828z" />
...
/** Gmail-style mark for primary work contact CTA */
export function IconGmail({ className = '', ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden {...props}>
      <path
        fill="#EA4335"
        d="M22 6.6v10.8c0 1.33-1.07 2.4-2.4 2.4H4.4A2.4 2.4 0 0 1 2 17.4V6.6C2 5.47 2.7 4.5 3.73 4.1L12 10.5l8.27-6.4c1.03.4 1.73 1.37 1.73 2.5Z"
      />
      <path
        fill="#FBBC05"
        d="m21.6 4.5-9.6 7.4L2.4 4.5A2.39 2.39 0 0 1 4.4 3h15.2c.77 0 1.45.36 1.9.92l.1.58Z"
      />
      <path
        fill="#34A853"
        d="M2 6.6v10.8c0 1.33 1.07 2.4 2.4 2.4h.4V7.5L2 6.6Z"
      />
      <path
        fill="#4285F4"
        d="M22 6.6v10.8c0 1.33-1.07 2.4-2.4 2.4h-.4V7.5l.4-.9Z"
      />
    </svg>
  )
}
